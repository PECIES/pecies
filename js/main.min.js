...
function startexperience() {
    ...
    setTimeout(function() {
        ...
        $(".nowebkitbrowser").length && nowebkitnextorprevanimal()
    }, 400),
    $(".nowebkitbrowser").length && $(".main-nav").addClass("no-mute")
}
...
function animalSmashKey() {
    $(".smash").length || $(".all-animals").length || $(".preloader-layer-2").length || $(".overlay.active").length || (turnoffslideshow(),
    smashanimalprocess())
}
...
function nextorprevanimal() {
    ...
    setTimeout(function() {
        ...
        0 == newAnimal ? ($(".prev .popout").text(animalNames[29]),
        $(".next .popout").text(animalNames[1])) : 29 == newAnimal ? ($(".prev .popout").text(animalNames[28]),
...
function smashanimalprocess() {
    $(".chromebrowser").length && SOUNDS.play("smashpiano"),
...
function chartquery() {
    if ($(".statistics .stats-ui").removeClass("one two three four"),
...
preLoader();
var app, animalanimationstate = 0, currentChartNumber = 0, browservar = 0, slideshowvar = 0, finishedAnimals = 29;
newAnimal = 0;
var prevAnimal = 0
  , skipped = 0
  , forcelinesshift = 50
...
$(document).ready(function() {
    ...
    $(".start-experience, .skip-intro a").on("click", function() {
        skipped = 1,
        startexperience()
    }),
    ...
    $(".animalinfo .wallpaper").on("click", function() {
        ...
        $(".overlay .download img").attr("src", a),
        // $(".overlay .download li:nth-child(1) a").attr("href", a),
        // $(".overlay .download li:nth-child(2) a").attr("href", e),
        // $(".overlay .download li:nth-child(3) a").attr("href", n),
        // $(".overlay .download li:nth-child(4) a").attr("href", i),
        overlayprocess()
    }),
